      ...
      <div className={clsx('container', styles.heroContainer)}>
        ...
        <div className={styles.buttons}>
          <Link
            ...
            to="https://docs.google.com/forms/d/e/1FAIpQLSfQb7ErrFJBue_V2yyCTu9gi3MxnaXSRszGrUBO1D15qCREQw/viewform"
          >
          Indie Game Dev? Collaborate with us
          </Link>
          {/* <Link
            className={clsx(
              'button button--outline button--secondary button--lg',
...
export default function Home() {
  ...
  return (
    <>
      <Layout
        title={`Integrable Cryptocurrency for Web 2.0 games`}
        description="Cross platform currency for Web 2.0 games <head />"
      >
        <HomepageHeader />
        <main>
